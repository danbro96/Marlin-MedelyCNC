...
#define STRING_CONFIG_H_AUTHOR "(Daniel Broström, default config)"  // Who made the changes.
...
#define DEFAULT_bedKp 69.39
#define DEFAULT_bedKi 8.39
#define DEFAULT_bedKd 382.73
